...
1. **Coordinate-Based Selection**: The grid structure enables precise targeting of **Question**s and their related answers.
...
- The outputed **Section** always produce the **Key** (good answer) as **Option** 1, while the **Distractor**s (bad answers) are the next **Option**s.
